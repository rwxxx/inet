...
void Ieee80211OFDMTransmitter::appendPadding(BitVector *serializedPacket, unsigned int dataBitsLength, uint8_t rate) const
{
...
const Ieee80211OFDMMode *Ieee80211OFDMTransmitter::computeMode(Hz bandwidth) const
{
