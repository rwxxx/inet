...
void ICMPv6Serializer::serialize(const cPacket *_pkt, Buffer &b, Context& c)
{
    ...
    switch (pkt->getType()) {
        ...
        case ICMPv6_DESTINATION_UNREACHABLE: {
            ...
            SerializerBase::lookupAndSerialize(pkt->getEncapsulatedPacket(), b, c, ETHERTYPE, ETHERTYPE_IPv6, 0);
            break;
        }
...
cPacket *ICMPv6Serializer::deserialize(Buffer &b, Context& context, ProtocolGroup group, int id)
{
    ASSERT(b.getPos() == 0);
